...
class SimConfig:
    ...
    frontier_entry_influence_threshold: float = 0.3
    ...
    home_support_food_amount: float = 0.18
    home_support_food_reserve: float = 55.0
    ...
    agent_min_lifespan: int = 12000
    agent_max_lifespan: int = 30000
    harvest_amount: float = 1.0
    pickup_amount: float = 1.5
    deposit_amount: float = 2.0
    withdraw_amount: float = 1.5
    home_food_upkeep: float = 0.012
    home_starvation_damage: float = 0.02
    ...
    home_birth_interval: int = 45
    opportunistic_deposit_amount: float = 0.75
    seed_home_food: float = 260.0
    seed_home_wood: float = 28.0
    seed_home_stone: float = 28.0
    seed_home_parts: float = 80.0
    seed_ground_cache: float = 24.0
    new_home_food: float = 24.0
