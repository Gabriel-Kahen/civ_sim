...
class SimConfig:
    ...
    initial_home_count: int = 2
    initial_home_spacing: int = 8
    spawn_radius: int = 3
    ...
    video_center_y: int = 0
    video_view_width_tiles: int = 128
    video_view_height_tiles: int = 128
    video_pixels_per_tile: int = 8
    influence_activation_threshold: float = 1.5
    influence_radius: int = 6
    dormancy_threshold: float = 0.4
    expansion_density_threshold: float = 3.2
    expansion_min_structures: int = 18
    resource_regen_rate: float = 0.002
    quality_drift_strength: float = 0.0008
    hazard_damage_scale: float = 0.06
    base_energy_decay: float = 0.035
    carried_energy_decay: float = 0.006
    founder_energy_decay_scale: float = 0.32
    founder_support_ticks: int = 600
    home_support_radius: int = 7
    home_support_energy_threshold: float = 15.0
    home_support_food_amount: float = 0.35
    food_energy_gain: float = 6.5
    carried_food_eat_threshold: float = 11.0
    structure_food_eat_threshold: float = 11.0
    max_energy: float = 30.0
    founder_energy_min: float = 22.0
    founder_energy_random: float = 6.0
    founder_carried_parts: float = 7.0
    offspring_energy: float = 16.0
    harvest_amount: float = 1.0
    pickup_amount: float = 1.5
    deposit_amount: float = 2.0
    withdraw_amount: float = 1.5
    home_food_upkeep: float = 0.22
    home_starvation_damage: float = 0.035
    home_low_access_damage: float = 0.015
    reproduction_food_threshold: float = 22.0
    reproduction_parts_threshold: float = 4.0
    reproduction_food_cost: float = 7.0
    reproduction_parts_cost: float = 1.0
    seed_home_food: float = 120.0
    seed_home_wood: float = 24.0
    seed_home_stone: float = 24.0
    seed_home_parts: float = 60.0
    seed_ground_cache: float = 20.0
    new_home_food: float = 16.0
    ...
    workshop_resource_threshold: float = 35.0
    ...
    workshop_min_distance: int = 5
    workshop_resource_radius: int = 3
    workshop_access_threshold: float = 0.8
