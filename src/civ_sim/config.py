...
class SimConfig:
    ...
    resource_regen_rate: float = 0.009
    quality_drift_strength: float = 0.0008
    hazard_damage_scale: float = 0.06
    base_energy_decay: float = 0.019
    carried_energy_decay: float = 0.003
    founder_energy_decay_scale: float = 0.22
    founder_support_ticks: int = 2200
    home_support_radius: int = 20
    home_support_energy_threshold: float = 22.0
    home_support_food_amount: float = 0.2
    home_support_food_reserve: float = 45.0
    food_energy_gain: float = 11.0
    carried_food_eat_threshold: float = 12.0
    structure_food_eat_threshold: float = 12.5
    max_energy: float = 36.0
    founder_energy_min: float = 24.0
    founder_energy_random: float = 5.0
    founder_carried_parts: float = 9.0
    offspring_energy: float = 28.0
    agent_min_lifespan: int = 30000
    agent_max_lifespan: int = 90000
    harvest_amount: float = 1.0
    pickup_amount: float = 1.5
    deposit_amount: float = 3.0
    withdraw_amount: float = 1.5
    home_food_upkeep: float = 0.004
    home_starvation_damage: float = 0.002
    home_low_access_damage: float = 0.0015
    reproduction_food_threshold: float = 14.0
    reproduction_parts_threshold: float = 0.8
    reproduction_food_cost: float = 2.0
    reproduction_parts_cost: float = 0.2
    home_birth_interval: int = 35
    opportunistic_deposit_amount: float = 1.75
    seed_home_food: float = 650.0
    seed_home_wood: float = 50.0
    seed_home_stone: float = 50.0
    seed_home_parts: float = 180.0
    seed_ground_cache: float = 36.0
    new_home_food: float = 90.0
    workshop_parts_output: float = 3.0
    workshop_wood_input: float = 0.8
    workshop_stone_input: float = 0.8
    structure_decay_multiplier: float = 0.35
    ...
    maintenance_parts_per_tick: float = 0.012
    maintenance_health_per_part: float = 30.0
    maintenance_inventory_radius: int = 7
