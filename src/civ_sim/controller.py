...
FOUNDER_ARCHETYPES = {
    "forager": {
        "traits": {
            ...
            "harvest_wood_bias": 0.25,
            "harvest_stone_bias": -0.1,
        ...
        "action_bias": {
            ...
            ActionType.DEPOSIT: 1.6,
            ActionType.WITHDRAW: 0.05,
    ...
    "courier": {
        ...
        "action_bias": {
            ...
            ActionType.DEPOSIT: 1.45,
            ActionType.WITHDRAW: 0.55,
    ...
    "builder": {
        ...
        "action_bias": {
            ActionType.MOVE: 0.5,
            ActionType.DEPOSIT: 1.05,
            ActionType.WITHDRAW: 0.55,
            ActionType.BUILD_PATH: 0.6,
            ActionType.BUILD_STORAGE: 0.35,
            ActionType.BUILD_BEACON: 0.2,
            ActionType.BUILD_HOME: 0.25,
            ActionType.BUILD_WORKSHOP: 1.75,
    ...
    "mason": {
        ...
        "action_bias": {
            ...
            ActionType.HARVEST: 0.65,
            ActionType.DEPOSIT: 1.1,
            ActionType.WITHDRAW: 0.35,
            ActionType.BUILD_WALL: 0.65,
            ActionType.BUILD_GATE: 0.45,
            ActionType.BUILD_WORKSHOP: 0.8,
